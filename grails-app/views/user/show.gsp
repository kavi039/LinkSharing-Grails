...
<%@ page import="linksharingagain.User" %>
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.photoPath}">
				<li class="fieldcontain">
					<span id="photoPath-label" class="property-label"><g:message code="user.photoPath.label" default="Photo Path" /></span>
					
						<span class="property-value" aria-labelledby="photoPath-label"><g:fieldValue bean="${userInstance}" field="photoPath"/></span>
